...
/*   Updated: 2023/03/17 12:36:01 by yejlee2          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	decide_tile(t_game mix, char c, int x, int y)
{
	...
	else if (c == 'P')
	{
		if (mix.num % 3 == 1)
			...
			put_image(mix, "./images/Dawn/Dawn_front_01.xpm", x, y);
		else if (mix.num % 3 == 0)
			put_image(mix, "./images/Dawn/Dawn_front_02.xpm", x, y);
	}
	else if (c == 'G')
	{
		if (mix.num % 3 == 1)
			put_image(mix, "./images/Galaxy/Galaxy_front_00.xpm", x, y);
		else if (mix.num % 3 == 2)
			put_image(mix, "./images/Galaxy/Galaxy_front_01.xpm", x, y);
		else if (mix.num % 3 == 0)
			put_image(mix, "./images/Galaxy/Galaxy_front_02.xpm", x, y);
	}
}
